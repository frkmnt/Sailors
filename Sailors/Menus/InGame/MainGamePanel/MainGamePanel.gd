...
var c_choose_card_panel
var c_do_card_panel
var c_keep_card_panel
...
func _ready():
	...
	c_choose_card_panel = $CardPanelContainer/ChooseCard
	c_do_card_panel = $CardPanelContainer/DoCardPanel
	c_keep_card_panel = $CardPanelContainer/KeepCardPanel
	c_player_label = $CurrentPlayerLabel
	r_current_panel = c_choose_card_panel


func initialize_card_panels():
	c_choose_card_panel.initialize(self)
	c_do_card_panel.initialize(self)
	c_keep_card_panel.initialize(self)
...
func set_card_panel(card_data):
	...
	match card_type_id:
		0: # choose
			enable_panel(c_choose_card_panel, card_data)
		1: # do 
			enable_panel(c_do_card_panel, card_data)
		2: # keep
			enable_panel(c_keep_card_panel, card_data)

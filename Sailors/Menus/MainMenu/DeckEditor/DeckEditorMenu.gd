...
#==== Components ====#
var c_deck_editor_accordion = preload("res://Menus/MainMenu/DeckEditor/DeckEditorAccordion.tscn")
var c_deck_editor_item = preload("res://Menus/MainMenu/DeckEditor/DeckEditorAccordionItem.tscn")
...
func on_delete_button_click():
	r_menu_container.on_deck_editor_delete_button(s_file_path, i_deck_index)

func on_add_card_button_click():
	r_menu_container.on_deck_editor_add_card_button()

func on_back_button():
	var deck = create_deck_from_current_cards()
	r_menu_container.on_deck_editor_back_button(deck)
